...
currentpath=$(pwd)
mkdir -p $currentpath/output_cassandra9881
rm -rf $currentpath/output_cassandra9881/*
...
cd $path
cp $currentpath/confFiles/conf_cassandra9881 $path/conf
java -cp $libs:$(pwd):$CLASSPATH cassandra9881.MainDriver cassandra9881.Scrubber