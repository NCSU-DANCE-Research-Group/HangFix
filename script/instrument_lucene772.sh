...
currentpath=$(pwd)
mkdir -p $currentpath/output_lucene772
rm -rf $currentpath/output_lucene772/*
...
cd $path
cp $currentpath/confFiles/conf_lucene772 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeMissingTimeout.MainDriver lucene772.Buggycode