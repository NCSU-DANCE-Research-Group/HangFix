...
cd $path
cp -r hadoop2FSDataIPS sootOutput/hadoop2FSDataIPS
cp -r hadoop2Conf sootOutput/hadoop2Conf
cp -n hadoop15417/* sootOutput/hadoop15417/ #copy but not override
cd sootOutput/
java -cp $libs:$(pwd):$CLASSPATH hadoop15417.testcode