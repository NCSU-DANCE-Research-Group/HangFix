...
currentpath=$(pwd)
mkdir -p $currentpath/output_mapreduce6991
rm -rf $currentpath/output_mapreduce6991/*
...
cd $path
cp $currentpath/confFiles/conf_mapreduce6991 $path/conf
java -cp $libs:$(pwd):$CLASSPATH mapreduce6991.MainDriver mapreduce6991.TestProcfsBasedProcessTree mapreduce6991.TestProcfsBasedProcessTree\$RogueTaskThread