...
cd $path/sootOutput
java -cp $libs:$(pwd):$CLASSPATH soot.Main compress87.ZipArchiveInputStream -p jb use-original-names -f jimple
subl sootOutput/compress87.ZipArchiveInputStream.jimple