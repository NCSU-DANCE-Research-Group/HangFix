...
currentpath=$(pwd)
mkdir -p $currentpath/output_mapreduce6990
rm -rf $currentpath/output_mapreduce6990/*
...
cd $path
cp $currentpath/confFiles/conf_mapreduce6990 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeIOReturn.MainDriver mapreduce6990.Buggycode\$Reader