...
currentpath=$(pwd)
mkdir -p $currentpath/output_mapreduce7089
rm -rf $currentpath/output_mapreduce7089/*
...
libs=$libpath/guava-20.0.jar:$libpath/commons-lang-2.6.jar:$libpath/commons-logging-1.2.jar:$libpath/netty-3.7.0.Final-javadoc.jar:$libpath/netty-3.7.0.Final-sources.jar:$libpath/commons-io-2.6.jar:$libpath/netty-3.7.0.Final.jar:$libpath/commons-net-3.1.jar:$libpath/servlet-api-2.5.jar:$libpath/commons-collections-3.2.1.jar:$libpath/jackson-core-asl-1.9.13.jar:$libpath/guava-21.0.jar
cd $path
cp $currentpath/confFiles/conf_mapreduce7089 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeDataContent.MainDriver mapreduce7089.Buggycode\$ReadMapper mapreduce7089.Buggycode 