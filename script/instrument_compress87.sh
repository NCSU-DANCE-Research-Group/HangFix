...
currentpath=$(pwd)
mkdir -p $currentpath/output_compress87
rm -rf $currentpath/output_compress87/*
...
cd $path
cp $currentpath/confFiles/conf_compress87 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeIOReturn.MainDriver compress87.ZipArchiveInputStream