...
currentpath=$(pwd)
mkdir -p $currentpath/output_hive5235
rm -rf $currentpath/output_hive5235/*
...
cd $path
cp $currentpath/confFiles/conf_hive5235 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeMissingTimeout.MainDriver hive5235.Buggycode