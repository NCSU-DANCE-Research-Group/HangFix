...
currentpath=$(pwd)
mkdir -p $currentpath/output_yarn2905
rm -rf $currentpath/output_yarn2905/*
...
cd $path
cp $currentpath/confFiles/conf_yarn2905 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeIOReturn.MainDriver yarn2905.Buggycode