...
currentpath=$(pwd)
mkdir -p $currentpath/output_kafka6271
rm -rf $currentpath/output_kafka6271/*
...
cd $path
cp $currentpath/confFiles/conf_kafka6271 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeIOReturn.MainDriver kafka6271.Buggycode