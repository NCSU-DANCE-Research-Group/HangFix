...
cd $path
cp -r cassandraIO sootOutput/cassandraIO
# cp cassandra9881/testcode.class sootOutput/cassandra9881/
cp -n cassandra9881/* sootOutput/cassandra9881/ #copy but not override
cd sootOutput/
java -cp $(pwd):$CLASSPATH cassandra9881.testcode