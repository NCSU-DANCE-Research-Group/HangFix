...
cd $path
cp -n mapreduce6991/* sootOutput/mapreduce6991/ #copy but not override
cd sootOutput/
java -cp $libs:$(pwd):$CLASSPATH:/usr/share/java/junit4.jar org.junit.runner.JUnitCore mapreduce6991.TestProcfsBasedProcessTree