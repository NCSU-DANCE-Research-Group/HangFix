...
currentpath=$(pwd)
mkdir -p $currentpath/output_hadoop15424
rm -rf $currentpath/output_hadoop15424/*
...
cd $path
cp $currentpath/confFiles/conf_hadoop15424 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeDataContent.MainDriver hadoop15424.XDR