...
cd $path
cp $currentpath/confFiles/conf_hadoop8614 $path/conf
# java -cp $(pwd):$CLASSPATH hadoop8614.MainDriver hadoop8614.Buggycode
java -cp $(pwd):$CLASSPATH typeIOReturn.MainDriver hadoop8614.Buggycode