...
currentpath=$(pwd)
mkdir -p $currentpath/output_yarn163
rm -rf $currentpath/output_yarn163/*
...
cd $path
cp $currentpath/confFiles/conf_yarn163 $path/conf
java -cp $libs:$(pwd):$CLASSPATH typeIOReturn.MainDriver yarn163.Buggycode