...
public class TestDeleteBlockPool {
	public static final Log LOG = LogFactory.getLog(TestDeleteBlockPool.class);
...
//      fs1.delete(new Path("/alpha"), true); //comment this line, so trigger the hang
      
      /* This is the patch, should be generated by XXX
      long timeout = 5*3000;
