...
public class LeaseManagerPatch {
  public static final Log LOG = LogFactory.getLog(LeaseManagerPatch.class);
  ...
  LeaseManagerPatch(FSNamesystem fsnamesystem) {this.fsnamesystem = fsnamesystem;}
  ...
  synchronized boolean checkLeases() {
    ...
    while(leaseToCheck != null) {
      ...
      for(String p : leasePaths) {
        try {
          boolean completed = fsnamesystem.internalReleaseLeasePatch(leaseToCheck, p,
