...
public class invokeAnotherClassAnalysis extends BodyTransformer{
	...
	invokeAnotherClassAnalysis(String datavalName, SootMethod iomethod, String hangmethod, int type){
  ...
  protected void internalTransform(Body body, String phase, Map options) { 
	  ...
	  G.v().out.println("options = " + options);
	  G.v().out.println("body size is " + body.getUnits().size());
	  G.v().out.println("dataVar = " + datavalStr);
