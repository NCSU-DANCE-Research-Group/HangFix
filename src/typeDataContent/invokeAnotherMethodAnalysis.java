...
public class invokeAnotherMethodAnalysis {
	...
	invokeAnotherMethodAnalysis(String datavalName, SootMethod iomethod, String hangmethod, int type){
...
//	  }
	  ...
	  List<Stmt> stmts = MethodUtils.getMethodAllStmts2(body, G.v().out);
